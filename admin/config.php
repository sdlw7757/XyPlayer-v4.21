...
if(empty($_SESSION['hashstr']) || filter_input(INPUT_COOKIE, 'login_token')!=='1' || $_SESSION['hashstr']!==md5((isset($CONFIG["user"])?$CONFIG["user"]:"admin")."63468756")){echo "<script>location.href='load.php?url=login.htm'</script>";exit();}
