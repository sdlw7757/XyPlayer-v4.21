...
$banner=(isset($CONFIG['banner']['type']) ? $CONFIG['banner']['type'] : '0') ? $CONFIG['banner']['data']: $data['banner'];
...
<link rel="stylesheet" type="text/css" href="./templets/<?php echo $CONFIG['templets'];?>/css/common.css?v=20260831">
</head>
...
<script src="./static/js/index.js?v=20260901a"></script>
